...
//  final isGuest = ReadWriteValue('isGuest${AppConst.appName}', false);
  ...
  setYourCountry(String? yourCountry) {
    print("SetToken : $yourCountry");
    yourLocation.val = yourCountry;
  }
  ...
  String? getYourCountry(){
    return yourLocation.val ?? 'Choose your location';
  }
